    ...
    class FetchTimer extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... arg0) {
            ...
            try {
                ...
                String link = "http://"+serveradd+"/codes/time_reader.php";
    ...
    class UpdatePassword extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... arg0) {
            ...
            try {
                ...
                String link = "http://"+serveradd+"/codes/password_uploader.php";
    ...
    class UpdateTimer extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... arg0) {
            ...
            try {
                ...
                String link = "http://"+serveradd+"/codes/timer_uploader.php";
