...
public class ManageQuestionsActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    class GetQuestions extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            httppost = new HttpPost(
                    "http://"+serveradd+"/readQuestionTitles.php");
    ...
    class DeleteQuestion extends AsyncTask<Void, String, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                String link = "http://"+serveradd+"/codes/deleteQuestion.php";
