...
public class AddOrEditActivity extends AppCompatActivity {
    ...
    public static final String serveradd = "192.168.1.116";
    String reason;
    String idOfQuestion;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (reason.equals("edit")) {
            ...
            eq.execute();
            Toast.makeText(this, "Update this question",Toast.LENGTH_SHORT).show();
        } else {
    ...
    class AddQuestion extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... arg0) {
            ...
            try {
                ...
                String link = "http://"+serveradd+"/codes/addQuestion.php";
    ...
    class EditQuestion extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... arg0) {
            ...
            try {
                ...
                String link = "http://"+serveradd+"/codes/updateQuestion.php";
